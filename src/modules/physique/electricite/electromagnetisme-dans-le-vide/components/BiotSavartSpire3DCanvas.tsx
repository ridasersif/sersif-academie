  ...
  return (
    <div className="w-full max-w-[800px] mx-auto flex flex-col">
      ...
      <div className="w-full bg-card border border-border border-t-0 rounded-b-2xl p-3 sm:p-4 flex flex-col gap-3 sm:gap-4">
        ...
        <div className="w-full flex items-center justify-center text-emerald-500 dark:text-emerald-400 overflow-x-auto py-2.5 px-3 bg-slate-900/50 rounded-xl border border-slate-800/50">
          <LatexMath 
