...
export default function ChimiePage() {
  const modules = [
    { id: "atomistique", title: "Atomistique" },
    { id: "thermochimie", title: "Thermochimie" },
    { id: "cinetique-chimique", title: "Cinétique chimique" },
    { id: "chimie-des-solutions", title: "Chimie des solutions" },
    { id: "cristallographie", title: "Cristallographie" },
    { id: "chimie-organique", title: "Chimie organique" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <header className="w-full p-6 border-b border-gray-200 dark:border-gray-800 flex items-center">
        ...
        <h1 className="text-2xl font-bold ml-6 text-foreground">Modules de Chimie</h1>
      </header>
          ...
          {modules.map((mod) => (
            <Link key={mod.id} href={`/cours/${mod.id}`} className="group block">
              <div className="bg-card text-card-foreground border border-gray-200 dark:border-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-200 transform group-hover:-translate-y-1">
                <div className="w-12 h-12 bg-emerald-100 dark:bg-emerald-900/50 rounded-lg flex items-center justify-center mb-4 text-emerald-600 dark:text-emerald-400 font-bold text-xl">
                  {mod.title.charAt(0)}
                </div>
